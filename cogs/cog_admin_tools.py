...
class AdminTools(commands.Cog):
    ...
    @commands.command(name='load_cog()', help='load a cog')
    ...
    @commands.command(name='unload_cog()', help='unload a cog')
    ...
    @commands.command(name='list_cogs()', help='gives a list of loaded extensions')
    async def list_cogs(self, ctx):
        await ctx.send(', '.join(self.bot.extensions))

    @commands.command(name='logout()', help='logout', aliases=['gtfo()'])
