from discord.ext.commands.view import _all_quotes, _quotes
...
def clean_string(content: str, prefix: str = "sentdebot "):
    ...
    # eval is not an option since even without builtins it is
    # Dangerous
    # we could just replace the commas,
    # but the args might have commas inside quotes!
    closer = ""
    inquotes = False
    on_backslash = False
    for i in args:
